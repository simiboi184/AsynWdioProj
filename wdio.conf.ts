...
export const config: WebdriverIO.Config = {
    ...
    // to run specific file --> npm test -- --spec ./test/feature/registertea.feature
    specs: [
        './test/features/**/*.feature'
        //'./test/features/**/appenv.feature'
        //'./test/features/**/waitex.feature'
        //'./test/features/**/registertea.feature'
    ...
    cucumberOpts: {
        ...
        //tagExpression: '@Regression,@xxxx',
        //to give something in terminal >>> e.g., npm test --- ---cucumberOpts.tagExpression="@Login" 'three hypens'
        tagExpression: '',
